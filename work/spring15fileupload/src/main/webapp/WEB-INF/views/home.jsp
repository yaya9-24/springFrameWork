		...
		<form action="s_insertOK.do" method="post"
			...
			<table id="insertTable">
				<tr>
					...
					<td><input type="text" id="pname" name="pname" value="BMW"
						placeholder="상품이름을 입력하세요"></td>
				</tr>
				<tr>
					<td><label for="model">모델이름</label></td>
					<td><input type="text" name="model" id="model" value="M5"
						placeholder="모델명을 입력하세요."></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input type="text" id="user_id" name="user_id" value="admin1"></td>
				</tr>
				<tr>
