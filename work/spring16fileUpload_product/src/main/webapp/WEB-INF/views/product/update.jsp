...
<div>
    ...
    <form action="p_updateOK.do" method="post" enctype="multipart/form-data">
        <table id="insertTable">
            ...
            <tr>
                <td><label for="file">파일</label><img src="resources/upload_img/thumb_${vo2.img_name}" width="200"></td>
                <td>
                <input type="file" id="file" name="file">
                <input type="hidden" id="img_name" name="img_name" value=${vo2.img_name} >
                </td>
            </tr>
            <tr>
